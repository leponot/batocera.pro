...
apps=(
    ...
    ["ANDROID/BLISS-OS/DOCKER/QEMU"]="curl -Ls https://github.com/leponot/batocera.pro/raw/main/docker/bliss_install.sh | bash" 
    ["ANTIMICROX"]="curl -Ls antimicrox.batocera.pro | bash"
    ["APPIMAGE-PARSER"]="curl -Ls appimage.batocera.pro | bash"
    ["APPLEWIN/WINE"]="curl -Ls https://github.com/leponot/batocera.pro/raw/main/applewin/applewin.sh | bash"
    ...
    ["CASAOS/CONTAINER/DEBIAN/XFCE"]="curl -Ls https://github.com/leponot/batocera.pro/raw/main/docker/casa.sh | bash"
    ...
    ["DOCKER"]="curl -Ls  https://github.com/leponot/batocera.pro/raw/main/docker/install.sh | bash"    
    ...
    ["EMBY/DOCKER"]="curl -Ls https://github.com/leponot/batocera.pro/raw/main/docker/emby.sh | bash"
    ...
    ["JELLYFIN/DOCKER"]="curl -Ls https://github.com/leponot/batocera.pro/raw/main/docker/jellyfin.sh | bash"
    ...
    ["LINUX-DESKTOPS-RDP/DOCKER"]="curl -Ls https://github.com/leponot/batocera.pro/raw/main/docker/rdesktop.sh | bash"
    ["LINUX-VMS-ON-QEMU/DOCKER"]="curl -Ls https://github.com/leponot/batocera.pro/raw/main/docker/qemu.sh | bash"
    ...
    ["MINECRAFT-BEDROCK-EDITION"]="curL -Ls https://raw.githubusercontent.com/leponot/batocera.pro/main/bedrock/bedrock.sh"
    ...
    ["NEXTCLOUD/DOCKER"]="curl -Ls https://github.com/leponot/batocera.pro/raw/main/docker/nextcloud.sh | bash" 
    ...
    ["PLEX/DOCKER"]="curl -L https://github.com/leponot/batocera.pro/raw/main/docker/plex.sh | bash"
    ["PLEXAMP"]="curl -Ls plexamp.batocera.pro | bash"
    ["POKEMMO"]="curl -Ls pokemmo.batocera.pro | bash"
    ["PORTAINER/DOCKER"]="curl -Ls https://github.com/leponot/batocera.pro/raw/main/docker/install.sh | bash"
    ...
    ["SABNZBD/DOCKER"]="curl -Ls https://github.com/leponot/batocera.pro/raw/main/docker/sabnzbd.sh | bash"
    ["SAK"]="curl -Ls sak.batocera.pro | bash"
    ["SAYONARA"]="curl -Ls sayonara.batocera.pro | bash"
    ["SHEEPSHAVER"]="curl -Ls https://github.com/leponot/batocera.pro/raw/main/sheepshaver/install.sh | bash"
    ...
    ["WINDOWS-VMS/DOCKER"]="curl -Ls https://github.com/leponot/batocera.pro/raw/main/docker/win.sh | bash"
    ["WINE-CUSTOM-DOWNLOADER/v40+"]="curl -Ls https://github.com/leponot/batocera.pro/raw/main/wine-custom/wine.sh | bash"
