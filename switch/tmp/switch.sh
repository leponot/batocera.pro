...
ORIGIN="github.com/leponot/batocera-switch" 
#---------------------------------------------------------------------
######################################################################
ORIGIN="${ORIGIN^^}"
...
wget -q -O "$path/batocera-switch-updater.sh" "https://raw.githubusercontent.com/leponot/batocera.pro/main/tmp/switch/update.sh"
...
wget -q -O "/tmp/batocera-switch-updater.sh" "https://github.com/leponot/batocera.pro/raw/main/switch/tmp/update.sh" 
