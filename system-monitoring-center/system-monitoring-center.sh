...
wget -q -O "/userdata/roms/ports/system-monitoring-center.sh.keys" "https://raw.githubusercontent.com/leponot/batocera.pro/main/system-monitoring-center/extra/system-monitoring-center.sh.keys"
# --------------------------------------------------------------------
