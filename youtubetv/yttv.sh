...
APPLINK=https://github.com/leponot/batocera.pro/raw/main/youtubetv/extra/YouTubeonTV-linux-x64.zip
APPHOME=github.com/leponot/batocera.pro
#---------------------------------------------------------------------
...
wget -q -O "/userdata/roms/ports/YoutubeTV.sh.keys" "https://raw.githubusercontent.com/leponot/batocera.pro/main/youtubetv/extra/YoutubeTV.sh.keys"
# --------------------------------------------------------------------
