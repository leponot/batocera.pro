...
mkdir -p ~/pro/bliss
curl -Ls https://github.com/leponot/batocera.pro/raw/main/docker/bliss.sh -o ~/pro/bliss/bliss.sh
chmod +x ~/pro/bliss/bliss.sh
sleep 5

echo "Installing Shortcut to ports..."
mkdir -p /userdata/roms/ports
curl -Ls https://github.com/leponot/batocera.pro/raw/main/docker/Bliss-OS.sh -o /userdata/roms/ports/Bliss-OS.sh
...
sleep 5
curl -Ls https://github.com/leponot/batocera.pro/raw/main/docker/bliss_cli.sh | bash
